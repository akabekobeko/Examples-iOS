...
@property(nonatomic) UIScrollView* scrollView;    //! グリッド配置されるアイテムの表示領域
@property(nonatomic) NSMutableSet* recycledItems; //! 再利用されるアイテム
@property(nonatomic) NSMutableSet* visibleItems;  //! 表示されるアイテム
